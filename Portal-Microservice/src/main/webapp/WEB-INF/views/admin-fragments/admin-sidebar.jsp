...
<div class="side-navbar">
	...
	<li><a href="/portal/specialists">Our Specialists</a></li>
        ...
        <li><a href="/portal/addSpecialist">Add Specialist</a></li>
        <li><a href="/portal/showSpecialistByExpertise" style="color: blue">Specialist By Expertise</a></li>
        <li><a href="/portal/showDeleteSpecialist">Delete Specialist</a></li>
        <li><a href="/portal/showUpdatePackages">Update Packages</a></li>
